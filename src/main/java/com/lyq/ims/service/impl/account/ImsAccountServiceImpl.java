package com.lyq.ims.service.impl.account;
...
@Service("imsAccountService")
@Transactional
public class ImsAccountServiceImpl extends CommonServiceImpl implements ImsAccountServiceI {
	 ...
	 * @return
	 */
	private void doAddBus(ImsAccountEntity t) throws Exception{
 	}
 	/**
	 * 更新操作增强业务
	 * @param t
	 * @return
	 */
	private void doUpdateBus(ImsAccountEntity t) throws Exception{
 	}
 	/**
	 * 删除操作增强业务
	 * @param id
	 * @return
	 */
	private void doDelBus(ImsAccountEntity t) throws Exception{
 	}
 	
 	private Map<String,Object> populationMap(ImsAccountEntity t){
	 ...
	 * @return
	 */
 	public String replaceVal(String sql,ImsAccountEntity t){
