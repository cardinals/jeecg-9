package com.lyq.ssj.service.impl.tally;
...
@Service("ssjTallyService")
@Transactional
public class SsjTallyServiceImpl extends CommonServiceImpl implements SsjTallyServiceI {
	 ...
	 * @return
	 */
	private void doAddBus(SsjTallyEntity t) throws Exception{
 	}
 	/**
	 * 更新操作增强业务
	 * @param t
	 * @return
	 */
	private void doUpdateBus(SsjTallyEntity t) throws Exception{
 	}
 	/**
	 * 删除操作增强业务
	 * @param id
	 * @return
	 */
	private void doDelBus(SsjTallyEntity t) throws Exception{
 	}
 	
 	private Map<String,Object> populationMap(SsjTallyEntity t){
	 ...
	 * @return
	 */
 	public String replaceVal(String sql,SsjTallyEntity t){
