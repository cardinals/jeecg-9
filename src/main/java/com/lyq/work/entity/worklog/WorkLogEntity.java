...
public class WorkLogEntity implements java.io.Serializable {
    ...
    public void setDate(java.util.Date date) {
        this.date = date;
        if (date != null) {
            this.week = DateUtilsEx.getWeekOfDate(date);
        }
    }
     ...
     * 方法: 取得java.lang.String
     *
     * @return: java.lang.String  礼拜
     */
    @Column(name = "WEEK", nullable = true, length = 10)
    public String getWeek() {
        if (week == null && date != null) {
            return DateUtilsEx.getWeekOfDate(date);
        }
        return week;
    }
