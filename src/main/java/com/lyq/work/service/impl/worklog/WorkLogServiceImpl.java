...
@Transactional
public class WorkLogServiceImpl extends CommonServiceImpl implements WorkLogServiceI {
	 ...
	 * @return
	 */
	private void doAddBus(WorkLogEntity t) throws Exception{
 	}
 	/**
	 * 更新操作增强业务
	 * @param t
	 * @return
	 */
	private void doUpdateBus(WorkLogEntity t) throws Exception{
 	}
 	/**
	 * 删除操作增强业务
	 * @param id
	 * @return
	 */
	private void doDelBus(WorkLogEntity t) throws Exception{
 	}
 	
 	private Map<String,Object> populationMap(WorkLogEntity t){
	 ...
	 * @return
	 */
 	public String replaceVal(String sql,WorkLogEntity t){
