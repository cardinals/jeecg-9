...
<html>
 ...
 <body>
		<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="imsAccountController.do?doUpdate" tiptype="1" >
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
					<tr>
						...
						<td class="value">
						     	 <input id="title" name="title" type="text" style="width: 150px" class="inputxt"  value='${imsAccountPage.title}'>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="account" name="account" type="text" style="width: 150px" class="inputxt"  value='${imsAccountPage.account}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="password" name="password" type="text" style="width: 150px" class="inputxt"  value='${imsAccountPage.password}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="url" name="url" type="text" style="width: 150px" class="inputxt"  value='${imsAccountPage.url}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						  	 	<textarea id="remark" style="width:600px;" class="inputxt" rows="6" name="remark">${imsAccountPage.remark}</textarea>
							<span class="Validform_checktip"></span>
