...
<html>
 ...
 <body>
		<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="ssjAccountController.do?doUpdate" tiptype="1" >
					...
					<input id="accountTypeId" name="accountTypeId" type="hidden" value="${ssjAccountPage.accountTypeId }">
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
					<tr>
						...
						<td class="value">
						     	 <input id="account" name="account" type="text" style="width: 150px" class="inputxt"  value='${ssjAccountPage.account}'>
