...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="ssjAccountTypeList" checkbox="true" fitColumns="false" title="随手记账户类型" actionUrl="ssjAccountTypeController.do?datagrid" idField="id" fit="true" queryMode="group">
   ...
   <t:dgCol title="流程状态"  field="bpmStatus"  hidden="true" queryMode="single" dictionary="sf_yn" width="120"></t:dgCol>
   <t:dgCol title="账户类型"  field="accountType"    queryMode="single"  width="120"></t:dgCol>
 ...
 <script src = "webpage/com/lyq/ssj/accounttype/ssjAccountTypeList.js"></script>		
