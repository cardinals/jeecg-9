...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="ssjAccountController.do?doAdd" tiptype="1" >
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
				<tr>
					...
					<td class="value">
					     	 <input id="account" name="account" type="text" style="width: 150px" class="inputxt"  datatype="*">
				...
				<tr>
					...
					<td class="value">
					     	 <input id="accountTypeId" name="accountTypeId" type="text" style="width: 150px" class="inputxt" >
							<span class="Validform_checktip"></span>
