...
<html>
 ...
 <body>
		<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="ssjAccountController.do?doUpdate" tiptype="1" >
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
					<tr>
						...
						<td class="value">
						     	 <input id="account" name="account" type="text" style="width: 150px" class="inputxt"  datatype="*" value='${ssjAccountPage.account}'>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="remark" name="remark" type="text" style="width: 150px" class="inputxt"  value='${ssjAccountPage.remark}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="accountTypeId" name="accountTypeId" type="text" style="width: 150px" class="inputxt"  value='${ssjAccountPage.accountTypeId}'>
							<span class="Validform_checktip"></span>
							<label class="Validform_label" style="display: none;">账户类型id</label>
						</td>
					<tr>
						<td align="right">
							<label class="Validform_label">
						...
						<td class="value">
						     	 <input id="accountType" name="accountType" type="text" style="width: 150px" class="inputxt"  value='${ssjAccountPage.accountType}'>
							<span class="Validform_checktip"></span>
  ...
  <script src = "webpage/com/lyq/ssj/ssjAccount.js"></script>		
