...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="ssjAccountList" checkbox="true" fitColumns="false" title="随手记账户" actionUrl="ssjAccountController.do?datagrid" idField="id" fit="true" queryMode="group">
   ...
   <t:dgCol title="账户类型id"  field="accountTypeId"   query="true" queryMode="single"  width="120"></t:dgCol>
 ...
 <script src = "webpage/com/lyq/ssj/ssjAccountList.js"></script>		
