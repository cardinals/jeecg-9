...
<html>
 ...
 <body>
		<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="ssjAccountTypeController.do?doUpdate" tiptype="1" >
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
					<tr>
						...
						<td class="value">
						     	 <input id="accountType" name="accountType" type="text" style="width: 150px" class="inputxt"  value='${ssjAccountTypePage.accountType}'>
  ...
  <script src = "webpage/com/lyq/ssj/type/ssjAccountType.js"></script>		
