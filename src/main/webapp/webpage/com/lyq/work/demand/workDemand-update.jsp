...
<html>
 ...
 <body>
		<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="workDemandController.do?doUpdate" tiptype="1" callback="jeecgFormFileCallBack@Override">
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
					...
					<tr>
						...
						<td class="value">
						     	 <input id="title" name="title" type="text" style="width: 150px" class="inputxt" datatype="*" value='${workDemandPage.title}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
									  <input id="proposeDate" name="proposeDate" type="text" style="width: 150px"  class="Wdate" onClick="WdatePicker()" value='<fmt:formatDate value='${workDemandPage.proposeDate}' type="date" pattern="yyyy-MM-dd"/>'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="programmer" name="programmer" type="text" style="width: 150px" class="inputxt"  value='${workDemandPage.programmer}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
									  <input id="finishTime" name="finishTime" type="text" style="width: 150px" class="Wdate" onClick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})" value='<fmt:formatDate value='${workDemandPage.finishTime}' type="date" pattern="yyyy-MM-dd hh:mm:ss"/>'>
							<span class="Validform_checktip"></span>
  ...
  <script src = "webpage/com/lyq/work/demand/workDemand.js"></script>
	  	<script type="text/javascript">
		  	...
		  	$(function(){
		  		...
		  		$.ajax({
		  		   type: "post",
		  		   url: "workDemandController.do?getFiles&id=" +  cgFormId,
