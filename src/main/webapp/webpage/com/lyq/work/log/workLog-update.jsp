...
<html>
 ...
 <body>
		<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="workLogController.do?doUpdate" tiptype="1" >
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
					<tr>
						...
						<td class="value">
						     	 <input id="title" name="title" type="text" style="width: 150px" class="inputxt"  value='${workLogPage.title}'>
					...
					<tr>
						...
						<td class="value">
						  	 	<textarea id="content" style="width:600px;" class="inputxt" rows="6" name="content">${workLogPage.content}</textarea>
							<span class="Validform_checktip"></span>
  ...
  <script src = "webpage/com/lyq/work/log/workLog.js"></script>		
